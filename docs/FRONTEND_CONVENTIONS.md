...
- Define Tailwind numeric palette utilities such as `bg-orange-500` only in `src/theme/**`.
...
- Keep route and marker render constants in domain render config modules, not inside provider components.
